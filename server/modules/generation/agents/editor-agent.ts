...
ЗАДАЧА:
Проанализируй сценарий и дай ОБЪЕКТИВНУЮ оценку по шкале 0-100 баллов.
...
- Не завышай оценку
- 80-90 это очень хороший сценарий
- 70-79 это хороший сценарий, но требует доработок
- Оценка выставляется по шкале 0-100 баллов и хранится без конвертации
