...
import { useAvatarImages, useProxiedVideo } from "./hooks"
...
export function Stage5AvatarSelection() {
  const { project, getStepData } = useStageData()
  const stepData = getStepData(4) // Step 4 data (voice, script, audio)
  const step5Data = getStepData(5) // Step 5 data (video status, videoId, videoUrl)
